...
export async function sendSignupOtpEmail(to: string, fullName: string, otp: string) {
  const htmlContent = `
    <!DOCTYPE html>
    <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="subtitle">Use the verification code below to complete your Kairo registration.</div>
          ...
          <p style="font-size: 14px; color: #A1A1AA; line-height: 1.5; margin: 0 0 24px;">
            Hi ${fullName},<br>
            Welcome to Kairo! This code will expire in 10 minutes. If you did not create an account, you can safely ignore this email.
          </p>
...
Use the verification code below to complete your Kairo registration:
